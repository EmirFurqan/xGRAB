...
<head>
    ...
    <title>Edit Profile - Movie Database</title>
...
<body class="bg-gray-900 min-h-screen text-gray-100">
    ...
    <div class="container mx-auto px-4 py-8">
        <a href="view.php" class="text-red-400 hover:text-red-300 mb-4 inline-block transition-colors duration-300 fade-in">
        ...
        <div class="bg-gray-800 rounded-xl shadow-lg p-8 max-w-2xl border border-gray-700 fade-in">
            ...
            <form method="post" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="flex space-x-3 pt-2">
                    ...
                    <a href="view.php" class="px-6 py-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 inline-block font-medium">
                        Cancel
                    </a>
                </div>
            </form>
            ...
            <div class="mt-8 pt-8 border-t border-gray-700">
                <button type="button" onclick="togglePasswordSection()" 
                    ...
                    <svg id="passwordToggleIcon" class="w-5 h-5 text-gray-400 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
