...
<head>
    ...
    <title>Delete Account - Movie Database</title>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 max-w-2xl">
            ...
            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-4">
                <strong>Warning:</strong> This action cannot be undone. All your data including reviews, watchlists, and profile information will be permanently deleted.
            </div>
