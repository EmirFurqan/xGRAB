...
<footer class="bg-gray-900 text-gray-300 border-t border-gray-800 mt-auto">
    ...
    <div class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div class="space-y-4">
                ...
                <p class="text-sm text-gray-400 leading-relaxed">
                    Your ultimate destination for discovering, tracking, and reviewing movies. Join our community of
                    film enthusiasts today.
                </p>
                <!-- Social Links -->
                <div class="flex gap-4 pt-2">
                    <a href="#"
                        class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-red-600 hover:text-white transition-all duration-300 transform hover:-translate-y-1">
            ...
            <div>
                ...
                <p class="text-sm text-gray-400 mb-4">Subscribe to get the latest movie news and updates.</p>
                <form class="flex gap-2" onsubmit="event.preventDefault(); alert('Newsletter feature coming soon!');">
                    <input type="email" placeholder="Enter email"
                        class="bg-gray-800 border-none rounded-lg px-4 py-2 text-sm w-full focus:ring-2 focus:ring-red-500 outline-none text-white">
                    <button type="submit"
                        class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-300">
                        Join
                    </button>
                </form>
            </div>
        ...
        <!-- Bottom Bar -->
        <div
            class="border-t border-gray-800 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
            <p>&copy; <?php echo date('Y'); ?> xGrab Movie Database. All rights reserved.</p>
            <div class="flex gap-6">
                <a href="#" class="hover:text-red-400 transition-colors duration-300">Privacy Policy</a>
                <a href="#" class="hover:text-red-400 transition-colors duration-300">Terms of Service</a>
                <a href="#" class="hover:text-red-400 transition-colors duration-300">Contact Us</a>
            </div>
        </div>
    </div>
</footer>