                    ...
                    <tbody class="bg-gray-800 divide-y divide-gray-700">
                        <?php while($user = mysqli_fetch_assoc($users_result)): ?>
                            <tr class="hover:bg-gray-700 transition-colors duration-200">
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300"><?php echo $user['user_id']; ?></td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300"><?php echo date('M d, Y', strtotime($user['join_date'])); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300"><?php echo $user['review_count']; ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300"><?php echo $user['watchlist_count']; ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    <?php if ($user['is_admin']): ?>
                                        <span class="bg-yellow-400 text-gray-900 px-2 py-1 rounded text-xs font-bold">Admin</span>
                                    <?php else: ?>
