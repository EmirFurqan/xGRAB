...
if (isset($_POST['submit'])) {
    ...
    if (empty($name)) {
        ...
        if (mysqli_query($conn, $insert_sql)) {
            ...
            $success = "Cast member added successfully! <a href='../../cast/details.php?id=$cast_id' class='underline'>View Cast Member</a>";
        } else {
...
<head>
    ...
    <title>Add Cast Member - Admin</title>
            ...
            <form method="post" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="biography" rows="6" 
                              placeholder="Enter cast member biography"
