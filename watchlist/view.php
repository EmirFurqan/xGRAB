...
<head>
    ...
    <title><?php echo htmlspecialchars($watchlist['watchlist_name']); ?> - xGrab</title>
            ...
            <div class="mb-4">
                <form method="get" class="inline-flex flex-wrap gap-2">
                    ...
                    <select name="sort"
                        ...
                        <option value="date_added" <?php echo $sort_by == 'date_added' ? 'selected' : ''; ?>>Date Added
                        </option>
                            ...
                            <?php if (isset($_SESSION['user_id'])):
                                ...
                                <form method="post" action="../favorites/toggle.php" class="absolute top-2 right-2 z-10">
                                    ...
                                    <input type="hidden" name="redirect_url"
                                        value="<?php echo htmlspecialchars($_SERVER['PHP_SELF'] . '?id=' . $watchlist_id); ?>">
                                    <button type="submit"
                            ...
                            <div class="flex items-center justify-center space-x-3 mt-4">
                                ...
                                <form method="post" action="../watched/toggle.php" class="inline">
                                    ...
                                    <button type="submit"
                                        ...
                                        <!-- Tooltip -->
                                        <span
                                            class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 text-xs text-white bg-gray-800 rounded-lg opacity-0 group-hover/icon:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none z-10 shadow-lg border border-gray-700">
                                ...
                                <form method="post" action="remove_movie.php" class="inline">
                                    ...
                                    <button type="submit"
                                        ...
                                        <!-- Tooltip -->
                                        <span
                                            class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 text-xs text-white bg-gray-800 rounded-lg opacity-0 group-hover/icon:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none z-10 shadow-lg">
