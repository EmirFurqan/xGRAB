...
<head>
    ...
    <title>Create Watchlist - Movie Database</title>
...
<body class="bg-gray-900 min-h-screen text-gray-100">
    ...
    <div class="container mx-auto px-4 py-8">
        <a href="index.php" class="text-indigo-400 hover:text-indigo-300 mb-4 inline-block transition-colors duration-300 fade-in">
        ...
        <div class="bg-gray-800 rounded-xl shadow-lg p-8 max-w-2xl border border-gray-700 fade-in">
            <h1 class="text-3xl font-bold mb-6 bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">
            ...
            <form method="post" class="space-y-6">
                ...
                <div class="flex space-x-3 pt-2">
                    ...
                    <a href="index.php" class="px-6 py-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 inline-block font-medium">
                        Cancel
                    </a>
                </div>
            </form>
