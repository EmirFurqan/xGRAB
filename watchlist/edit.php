...
<head>
    ...
    <title>Rename Watchlist - Movie Database</title>
...
<body class="bg-gray-900 min-h-screen text-gray-100">
    ...
    <div class="container mx-auto px-4 py-8">
        <a href="index.php" class="text-red-400 hover:text-red-300 mb-4 inline-block transition-colors duration-300 fade-in">
        ...
        <div class="bg-gray-800 rounded-xl shadow-lg p-8 max-w-2xl border border-gray-700 fade-in">
            ...
            <form method="post" class="space-y-6">
                <div>
                    ...
                    <input type="text" name="watchlist_name" value="<?php echo htmlspecialchars($watchlist['watchlist_name']); ?>" 
