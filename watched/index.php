...
<head>
    ...
    <title>My Watched Movies - Movie Database</title>
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <form method="get" class="flex flex-wrap gap-3 items-end">
                    <div>
                        ...
                        <select name="sort_by" class="px-3 py-2 bg-gray-700 border-2 border-gray-600 rounded-lg text-gray-100 focus:border-red-500 focus:ring-2 focus:ring-red-500 transition-all duration-300">
                            <option value="watched_date" <?php echo $sort_by == 'watched_date' ? 'selected' : ''; ?>>Date Watched</option>
                    ...
                    <div>
                        ...
                        <select name="sort_order" class="px-3 py-2 bg-gray-700 border-2 border-gray-600 rounded-lg text-gray-100 focus:border-red-500 focus:ring-2 focus:ring-red-500 transition-all duration-300">
                ...
                ?>
                    <div class="group bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-700 fade-in" style="animation-delay: <?php echo $delay; ?>ms">
                        <div class="relative">
                            ...
                            <form method="post" action="toggle.php" class="absolute bottom-2 right-2">
                                ...
                                <button type="submit" 
                                        ...
                                        onclick="return confirm('Remove this movie from watched?');">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-xs text-gray-500">Watched <?php echo date('M d, Y', strtotime($movie['watched_date'])); ?></p>
                        </div>
                    </div>
                <?php endwhile; ?>
            </div>
