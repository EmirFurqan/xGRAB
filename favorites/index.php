...
<head>
    ...
    <title>My Favorites - Movie Database</title>
        ...
        <div class="mb-8 fade-in">
            ...
            <?php if ($movies_count > 0): ?>
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
                    ...
                    ?>
                        <div class="group bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-700">
                            <div class="relative">
                                ...
                                <form method="post" action="toggle.php" class="absolute top-2 right-2">
                                    ...
                                    <button type="submit" class="relative group/icon p-2 bg-red-600/80 rounded-full hover:bg-red-600 transition-all duration-300" title="Remove from Favorites">
                            ...
                            <div class="p-4">
                                ...
                                <p class="text-xs text-gray-500 mt-2">Added <?php echo date('M d, Y', strtotime($fav['date_added'])); ?></p>
                            </div>
                        </div>
                    <?php endwhile; ?>
                </div>
                                    ...
                                    <div class="aspect-[2/3] bg-gray-200 flex items-center justify-center relative overflow-hidden">
                                        ...
                                        <?php else: ?>
                                            <div class="w-full h-full <?php echo $cast_color; ?> flex items-center justify-center">
                                                <span class="text-white text-4xl font-bold"><?php echo htmlspecialchars($cast_initial); ?></span>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </a>
                                    ...
                                    <div class="aspect-[2/3] bg-gray-200 flex items-center justify-center relative overflow-hidden">
                                        ...
                                        <?php else: ?>
                                            <div class="w-full h-full <?php echo $user_color; ?> flex items-center justify-center">
                                                <span class="text-white text-4xl font-bold"><?php echo htmlspecialchars($user_initial); ?></span>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </a>
