...
<body style="font-family: sans-serif; max-width: 900px; margin: 0 auto; padding: 20px; background-color: #fff;">
    ...
    <header style="margin-bottom: 20px;">
        <a href="index.php" style="text-decoration: none; font-size: 18px; color: #007bff;">&larr; Back to
            Watchlists</a>
    </header>

    <h1 style="border-bottom: 2px solid #eee; padding-bottom: 10px;">
        <?php echo htmlspecialchars($list['watchlist_name']); ?></h1>
    ...
    <table width="100%" cellspacing="0" cellpadding="15">
        ...
        <tbody>
            <?php if ($movies && $movies->num_rows > 0): ?>
                <?php while ($row = $movies->fetch_assoc()): ?>
                    <tr style="border-bottom: 1px solid #eee;">
                        ...
                        <td>
                            <strong><a
                                    href="movie_details.php?id=<?php echo $row['movie_id']; ?>"><?php echo htmlspecialchars($row['title']); ?></a></strong>
                        ...
                        <td align="center">
                            <form method="POST">
                                ...
                                <button type="submit"
                                    style="color: red; border: 1px solid red; background: white; padding: 5px 10px; cursor: pointer; border-radius: 4px;">Remove</button>
                            </form>
                        </td>
                    </tr>
                <?php endwhile; ?>
            <?php else: ?>
                <tr>
                    <td colspan="4" align="center">This list is empty.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
