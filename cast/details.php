...
<head>
    ...
    <title><?php echo htmlspecialchars($cast_member['name']); ?> - Cast Member</title>
...
<body class="bg-gray-900 min-h-screen text-gray-100">
    ...
    <div class="container mx-auto px-4 py-8">
        <a href="../movies/browse.php" class="inline-flex items-center text-red-400 hover:text-red-300 mb-6 font-medium transition-colors duration-300 fade-in">
        ...
        <div class="bg-gray-800 rounded-xl shadow-lg p-6 md:p-8 mb-6 border border-gray-700 fade-in">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    <?php if ($cast_member['photo_url']): ?>
                        <img src="<?php echo htmlspecialchars($cast_member['photo_url']); ?>" 
                             alt="<?php echo htmlspecialchars($cast_member['name']); ?>"
                             class="w-full rounded-lg shadow-lg">
                    <?php else: ?>
                        <div class="w-full aspect-[2/3] <?php echo $avatar_color; ?> rounded-lg flex items-center justify-center shadow-lg">
                            <span class="text-white text-6xl font-bold" style="white-space: nowrap; overflow: hidden; text-overflow: clip; user-select: none;"><?php echo $cast_initial; ?></span>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="md:col-span-2">
                    <h1 class="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent">
                    ...
                    <div class="mb-6">
                        ...
                        <?php if (isset($_SESSION['user_id'])): ?>
                            <form method="post" action="../favorites/toggle.php" class="inline">
                                ...
                                <input type="hidden" name="redirect_url" value="<?php echo htmlspecialchars($_SERVER['PHP_SELF'] . '?id=' . $cast_id); ?>">
                                <button type="submit" 
                    ...
                    <?php if ($cast_member['biography']): ?>
                        <div class="mb-6">
                            ...
                            <p class="text-gray-300 leading-relaxed"><?php echo nl2br(htmlspecialchars($cast_member['biography'])); ?></p>
                        </div>
                    <?php else: ?>
                        <div class="mb-6">
                            ...
                            <a href="../movies/details.php?id=<?php echo $movie['movie_id']; ?>" class="block">
                                <div class="aspect-[2/3] bg-gray-200 flex items-center justify-center relative overflow-hidden">
                                    ...
                                    <?php if ($movie['average_rating'] > 0): ?>
                                        <div class="absolute top-2 right-2 bg-yellow-400 text-gray-900 px-2 py-1 rounded-md text-xs font-bold flex items-center space-x-1 shadow-lg">
                                            <span>★</span>
                                ...
                                <div class="p-4">
                                    ...
                                    <?php if ($movie['character_name']): ?>
                                        <p class="text-xs text-red-400 font-medium">as <?php echo htmlspecialchars($movie['character_name']); ?></p>
                                    <?php endif; ?>
                                </div>
                            </a>
                        </div>
